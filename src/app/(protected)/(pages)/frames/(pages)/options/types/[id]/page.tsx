...
const generateMetadata = async ({
  ...
  if (!type) {
    return {
      title: "Tipo de marco no encontrado",
      description: "Tipo de marco no encontrado.",
    };
  }

  return {
    title: `Tipo de marco ${type.name}`,
    description: `Tipo de marco ${type.name}.`,
  };
};
...
const TypePage = async ({ params }: TypePageProps) => {
  ...
  if (!type) {
    return <div className="p-4">Tipo de marco no encontrado.</div>;
  }
