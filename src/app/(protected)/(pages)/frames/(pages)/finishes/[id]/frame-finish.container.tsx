...
// Hooks
import { FrameFinishHook } from "./hooks/frame-finish.hook";
// Types
import type { FrameFinishProps } from "./types/frame-finish.container.types";

const FrameFinishContainer = ({ frameFinish }: FrameFinishProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
    ...
    <div className="flex grow flex-col gap-2 overflow-hidden p-4">
      ...
      <Tabs defaultValue="details" className="flex-1 gap-4 overflow-hidden">
        ...
        <TabsContent className="overflow-auto" value="details">
          <Detail frameFinish={frameFinish} />
        </TabsContent>
