...
// Hooks
import { FrameModelHook } from "./hooks/frame-model.hook";
// Types
import type { FrameModelProps } from "./types/frame-model.container.types";

const FrameModelContainer = ({ frameModel }: FrameModelProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
