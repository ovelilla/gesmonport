...
// Hooks
import { FrameFamilyHook } from "./hooks/frame-family.hook";
// Types
import type { FrameFamilyProps } from "./types/frame-family.container.types";

const FrameFamilyContainer = ({ frameFamily }: FrameFamilyProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
    ...
    <div className="flex grow flex-col gap-2 overflow-hidden p-4">
      ...
      <Tabs defaultValue="details" className="flex-1 gap-4 overflow-hidden">
        ...
        <TabsContent className="overflow-auto" value="details">
          <Detail frameFamily={frameFamily} />
        </TabsContent>
