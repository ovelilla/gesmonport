...
// Actions
import { saveFrameFamilyPrices } from "../actions/frame-family.actions";
// Types
import type {
...
} from "./types/frame-family.handlers.types";
// Utils
...
const savePricesHandler = async ({
  ...
  try {
    const { prices, error, success } = await saveFrameFamilyPrices({
...
const FrameFamilyHandlers = ({
  data,
  frameFamily,
  setData,
  setLoading,
  setOriginalData,
}: FrameFamilyHandlersProps): FrameFamilyHandlersReturn => {
  return {
