...
// Hooks
import { FrameTypeHook } from "./hooks/frame-type.hook";
// Types
import type { FrameTypeProps } from "./types/frame-type.container.types";

const FrameTypeContainer = ({ frameType }: FrameTypeProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
