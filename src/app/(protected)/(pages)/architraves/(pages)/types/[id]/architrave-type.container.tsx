...
// Hooks
import { ArchitraveTypeHook } from "./hooks/architrave-type.hook";
// Types
import type { ArchitraveTypeProps } from "./types/architrave-type.container.types";

const ArchitraveTypeContainer = ({ architraveType }: ArchitraveTypeProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
    ...
    <div className="flex grow flex-col gap-2 overflow-hidden p-4">
      ...
      <Tabs defaultValue="details" className="flex-1 gap-4 overflow-hidden">
        ...
        <TabsContent className="overflow-auto" value="details">
          <Detail architraveType={architraveType} />
        </TabsContent>
...
export { ArchitraveTypeContainer };
