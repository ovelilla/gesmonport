...
// Hooks
import { ArchitraveModelHook } from "./hooks/architrave-model.hook";
// Types
import type { ArchitraveModelProps } from "./types/architrave-model.container.types";

const ArchitraveModelContainer = ({
  architraveModel,
}: ArchitraveModelProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
    ...
    <div className="flex grow flex-col gap-2 overflow-hidden p-4">
      ...
      <Tabs defaultValue="details" className="flex-1 gap-4 overflow-hidden">
        ...
        <TabsContent className="overflow-auto" value="details">
          <Detail architraveModel={architraveModel} />
        </TabsContent>
...
export { ArchitraveModelContainer };
