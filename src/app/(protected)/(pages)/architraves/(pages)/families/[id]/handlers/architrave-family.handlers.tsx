...
// Actions
import { saveArchitraveFamilyPrices } from "../actions/architrave-family.actions";
// Types
import type {
...
} from "./types/architrave-family.handlers.types";
// Utils
...
const savePricesHandler = async ({
  ...
  try {
    const { prices, error, success } = await saveArchitraveFamilyPrices({
      architraveFamilyId: architraveFamily.id,
      prices: parsedPrices,
    });
...
const ArchitraveFamilyHandlers = ({
  data,
  architraveFamily,
  setData,
  setLoading,
  setOriginalData,
}: ArchitraveFamilyHandlersProps): ArchitraveFamilyHandlersReturn => {
  return {
...
export { ArchitraveFamilyHandlers };
