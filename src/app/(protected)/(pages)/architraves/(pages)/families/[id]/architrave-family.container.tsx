...
// Hooks
import { ArchitraveFamilyHook } from "./hooks/architrave-family.hook";
// Types
import type { ArchitraveFamilyProps } from "./types/architrave-family.container.types";

const ArchitraveFamilyContainer = ({
  architraveFamily,
}: ArchitraveFamilyProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
    ...
    <div className="flex grow flex-col gap-2 overflow-hidden p-4">
      ...
      <Tabs defaultValue="details" className="flex-1 gap-4 overflow-hidden">
        ...
        <TabsContent className="overflow-auto" value="details">
          <Detail architraveFamily={architraveFamily} />
        </TabsContent>
...
export { ArchitraveFamilyContainer };
