...
// Hooks
import { GlassFinishHook } from "./hooks/glass-finish.hook";
// Types
import type { GlassFinishProps } from "./types/glass-finish.container.types";

const GlassFinishContainer = ({ glassFinish }: GlassFinishProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
    ...
    <div className="flex grow flex-col gap-2 overflow-hidden p-4">
      ...
      <Tabs defaultValue="details" className="flex-1 gap-4 overflow-hidden">
        ...
        <TabsContent className="overflow-auto" value="details">
          <Detail glassFinish={glassFinish} />
        </TabsContent>
