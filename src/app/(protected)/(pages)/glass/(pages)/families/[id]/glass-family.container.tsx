...
// Hooks
import { GlassFamilyHook } from "./hooks/glass-family.hook";
// Types
import type { GlassFamilyProps } from "./types/glass-family.container.types";

const GlassFamilyContainer = ({ glassFamily }: GlassFamilyProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
    ...
    <div className="flex grow flex-col gap-2 overflow-hidden p-4">
      ...
      <Tabs defaultValue="details" className="flex-1 gap-4 overflow-hidden">
        ...
        <TabsContent className="overflow-auto" value="details">
          <Detail glassFamily={glassFamily} />
        </TabsContent>
