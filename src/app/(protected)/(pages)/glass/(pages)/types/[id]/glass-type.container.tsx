...
// Hooks
import { GlassTypeHook } from "./hooks/glass-type.hook";
// Types
import type { GlassTypeProps } from "./types/glass-type.container.types";

const GlassTypeContainer = ({ glassType }: GlassTypeProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
