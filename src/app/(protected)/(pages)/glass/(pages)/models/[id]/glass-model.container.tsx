...
// Hooks
import { GlassModelHook } from "./hooks/glass-model.hook";
// Types
import type { GlassModelProps } from "./types/glass-model.container.types";

const GlassModelContainer = ({ glassModel }: GlassModelProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
