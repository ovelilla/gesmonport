...
// Hooks
import { DoorModelHook } from "./hooks/door-model.hook";
// Types
import type { DoorModelProps } from "./types/door-model.container.types";

const DoorModelContainer = ({ doorModel }: DoorModelProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
