...
// Hooks
import { DoorTypeHook } from "./hooks/door-type.hook";
// Types
import type { DoorTypeProps } from "./types/door-type.container.types";

const DoorTypeContainer = ({ doorType }: DoorTypeProps) => {
  const {
    data,
    handleAddColumn,
    handleAddRow,
