...
// Actions
import { saveDoorTypePrices } from "../actions/door-type.actions";
// Types
import type {
...
} from "./types/door-type.handlers.types";
// Utils
...
const savePricesHandler = async ({
  ...
  try {
    const { prices, error, success } = await saveDoorTypePrices({
...
const DoorTypeHandlers = ({
  data,
  doorType,
  setData,
  setLoading,
  setOriginalData,
}: DoorTypeHandlersProps): DoorTypeHandlersReturn => {
  return {
