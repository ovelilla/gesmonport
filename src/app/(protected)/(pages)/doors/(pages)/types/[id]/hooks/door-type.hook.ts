...
// Handlers
import { DoorTypeHandlers } from "../handlers/door-type.handlers";
// Hooks
...
import type {
  DoorTypeHookProps,
  DoorTypeHookReturn,
} from "./types/door-type.hook.types";
// Utils
import { prismaPricesToSpreadsheetData } from "../utils/prisma-prices-to-spreadsheet-data.util";

const DoorTypeHook = ({ doorType }: DoorTypeHookProps): DoorTypeHookReturn => {
