...
// Types
import type { DoorFormProps } from "./types/form.component.types";
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel htmlFor={field.name}>Vidrios</FormLabel>
              <FormControl>
                <MultiSelect
                  {...field}
                  options={glass.map((glass) => ({
                    label: glass.name,
                    value: glass.id,
                  }))}
                  onValueChange={field.onChange}
                  defaultValue={field.value}
                  placeholder="Selecciona los tipos de vidrio"
                  variant="inverted"
                />
              </FormControl>
              <FormMessage />
